...
var authorHtml = Handlebars.templates.authorTemplate({ authors });

var authorTemplate = document.getElementById("author-section");
authorTemplate.innerHTML = authorHtml;
